...
class EfficientnetImageClassificationLightningModule(ImageClassificationLightningModule):
    ...
    def __init__(self, backbone_fun, kwargs, get_x_method: Callable, num_classes, in_channels=3):
        
        kwargs["num_classes"] = 9
        backbone = self._initialize_backbone(backbone_fun, kwargs, False, in_channels)

        super().__init__(backbone, get_x_method, num_classes)

    def _initialize_backbone(self, backbone_fun, kwargs, first_layer_pretrained=False, in_channels=3):
